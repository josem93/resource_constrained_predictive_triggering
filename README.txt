...
definitions) and have the Statistics and Machine Learning toolbox installed.

Multi_Agent_Simulation.m:	Runs a single simulation using the parameters defined in params.m and
							the CACC vehicle model defined in multi_agent_setup.m

params.m:	Defines the simulation, trigger and network parameters needed to run the simulations.

multi_agent_setup.m: 	Defines the multi-agent system parameters (ie., number of agents, models)

Agent.m: 	Contains the class definition for a single agent, where the methods represnt the function
