...
sim.TRIG_TYPE = 'PT';            % trigger type {'ET','PT','PPT','ST'}
sim.ET_TYPE = 'ET1';
...
if(strcmp(sim.SIM_TYPE,'STOCHASTIC'))
    ...
    sim.P_CONSTRAINT = 0;      % comm prob constraint {0,1} (send when > h/2)
    sim.CAST_FLAG = 0;
...
if(strcmp(sim.ET_TYPE,'ET2'))
    % ET2: random selection of agents
